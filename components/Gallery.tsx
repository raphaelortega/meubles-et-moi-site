...
const PROJECTS: Project[] = [
  {
    id: 'verriere-atelier',
    title: 'Graphique & Verrière Atelier',
    location: 'Lyon',
    style: 'Contraste noir, bois clair & esprit loft',
    image: '/images/realisations/realisation-1.jpg',
    description: 'Une verrière atelier noire qui structure les volumes, associée à un canapé contemporain, une table basse gigogne et un meuble TV en bois naturel.',
    highlights: ['Verrière atelier noire', 'Table basse gigogne', 'Tapis motif végétal', 'Meuble TV bois clair'],
    co2: '1 250 kg CO₂ évités',
  },
  {
    id: 'scandinave-lumineux',
    title: 'Scandinave & Lumière Naturelle',
    location: 'Lyon',
    style: 'Tons doux, bois blond & atmosphère zen',
    image: '/images/realisations/realisation-2.jpg',
    description: 'Un espace baigné de lumière naturelle valorisé par une grande bibliothèque modulaire en chêne, un canapé d\'angle confortable et des matières apaisantes.',
    highlights: ['Grande bibliothèque modulaire en chêne', 'Canapé d’angle gris chiné', 'Table basse épurée', 'Touches moutarde'],
    co2: '980 kg CO₂ évités',
  },
  {
    id: 'retro-chic',
    title: 'Rétro-Chic & Bois Noble',
    location: 'Lyon',
    style: 'Chêne massif, vintage chiné & cannage rotin',
    image: '/images/realisations/realisation-3.jpg',
    description: 'Le charme de pièces chinées d\'exception : table en chêne massif sur pieds épingle, chaises vintage au veinage graphique, meuble TV cannage et table basse en verre.',
    highlights: ['Table chêne massif pieds épingle', 'Chaises vintage thermoformées', 'Meuble TV cannage rotin', 'Table basse verre & chrome'],
